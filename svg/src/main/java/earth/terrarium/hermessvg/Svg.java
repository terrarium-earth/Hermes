...
public class Svg extends BasicElement<HermesStyle, HermesRenderer> {
    ...
    public Svg(@NotNull HermesStyle style, @NotNull LayoutStyle layoutStyle, @Nullable Element<HermesStyle, HermesRenderer> parent, @NotNull String qName, @Nullable Attributes attributes) {
